{ stdenv, lib, fetchzip, autoPatchelfHook, jdk23, glib, gtk3, xorg, ffmpeg_6-full, sdrplay, openjfx23, glibc, libX11, makeWrapper, buildFHSUserEnv }:
let
    version = "0.6.1";
in
stdenv.mkDerivation {
    ...
    fixupPhase = ''
        ...
        #!/bin/sh
        exec ${buildFHSUserEnv}/bin/buildFHSUserEnv --extra-library-path ${lib.makeLibraryPath [ gtk3 openjfx23 libX11 glibc ]} --chroot \$@
        EOF
