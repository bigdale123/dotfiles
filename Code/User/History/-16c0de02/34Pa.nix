...
stdenv.mkDerivation {
    ...
    installPhase = ''
        ...
        # Use makeWrapper to create a wrapper for the java binary
        makeWrapper $out/bin/java $out/bin/sdrtrunk \
            --set LD_LIBRARY_PATH $out/lib:$out/lib/gtk-3.0:$LD_LIBRARY_PATH \
            --set GTK_PATH $out/lib/gtk-3.0
