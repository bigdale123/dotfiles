...
stdenv.mkDerivation {
    ...
    fixupPhase = ''
        substituteInPlace $out/bin/sdr-trunk --replace-fail 'JAVACMD="$JAVA_HOME/bin/java"' 'JAVACMD="LD_LIBRARY_PATH=${lib.makeLibraryPath [ gtk3 openjfx23 libX11 glibc ]} $JAVA_HOME/bin/java"'
    '';
