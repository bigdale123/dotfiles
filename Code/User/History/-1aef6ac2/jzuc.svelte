...
<div class="bg-cover bg-[url('/UAB_Blazer_Hall-3738225094.jpg')]">
    <div class="flex bg-white/60 backdrop-blur-sm rounded-lg p-2">
        ...
        <i class="flex-auto"> </i>
        <div class="flex">
            <a class="p-1" href="https://github.com/bigdale123"><img class="icon-rules" src="github.png" alt="Github"></a>
            <a class="p-1" href="https://www.linkedin.com/in/dylancalvin/"><img class="icon-rules" src="linkedin.png" alt="LinkedIn"></a>
        </div>
    </div>
    <slot />
</div>
