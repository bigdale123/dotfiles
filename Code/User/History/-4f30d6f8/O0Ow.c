...
int main(int argc, char **argv) {
    ...
    struct sockaddr* con_det_ptr = (struct sockaddr*)&connection_details;
    ...
    socklen_t *con_len = (socklen_t*)&connection_details;

    while(1) {
        int connection = accept(server, con_det_ptr, con_len);
        if (connection < 0) {
